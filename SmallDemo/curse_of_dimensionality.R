...
# Show that the area under curve is changing as the dimensinality increases. 
# X ~ N(0,1)
...
# Class 1 consists of observations whose absolute values
# of x1 and x2 are <1
...
# If the class-rule would be radil (Euclidean distance)
